import './common.css'
import './table.css' 
import ProjectImage from '../assets/Onam_celebration_1_50_0.jpg';
        ...
        <div className='page'>
            <div className="subpage">
                ...
                <div className="image-container">
                    <img src={ProjectImage} alt="Project Work/Fieldwork"/>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>.4 Students are expected to have a good knowledge of English. </p>
                                </td>
                            </tr>
                            <tr>
                                <td>3.</td>
                                ...
                                <td>
                                    ...
                                    <ul>
                                        ...
                                        <li>3.2.6 Acceptance letter from an IITPKD professor willing to guide the student throughout the Project work.</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><strong>5.3 Is course work compulsory for project work?</strong><br />
                                    No, it depends on your IITMPKD guide’s recommendation. If your guide suggests that you take few courses, you can register for the courses. </p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
